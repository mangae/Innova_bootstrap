# InnovaCoin
## Windows wallet - bootstrap (19/Jun/19)
- Bootstrap block ***397.489*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (19/Jun/19)
- Bootstrap block ***397.489*** for InnovaCoin Linux hot masternode.
