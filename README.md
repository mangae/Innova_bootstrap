# InnovaCoin
## Windows wallet - bootstrap (27/Jun/19)
- Bootstrap block ***402.058  *** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (27/Jun/19)
- Bootstrap block ***402.058*** for InnovaCoin Linux hot masternode.
