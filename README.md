# InnovaCoin
## Windows wallet - bootstrap (11/Aug/19)
- Bootstrap block ***424.646*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (11/Aug/19)
- Bootstrap block ***424.646*** for InnovaCoin Linux hot masternode.
