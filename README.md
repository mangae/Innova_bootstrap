# InnovaCoin
## Windows wallet - bootstrap (25/May/19)
- Bootstrap block **385.764** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (25/May/19)
- Bootstrap block **385.764** for InnovaCoin Linux hot masternode.
