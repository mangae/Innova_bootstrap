# InnovaCoin
## Windows wallet - bootstrap (31/May/19)
- Bootstrap block **388.950** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (31/May/19)
- Bootstrap block **388.950** for InnovaCoin Linux hot masternode.
