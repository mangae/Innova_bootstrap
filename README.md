# InnovaCoin
## Windows wallet - bootstrap (16/Jun/19)
- Bootstrap block ***396.322*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (16/Jun/19)
- Bootstrap block ***396.322*** for InnovaCoin Linux hot masternode.
