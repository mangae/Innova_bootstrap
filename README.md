# InnovaCoin
## Windows wallet - bootstrap (28/May/19)
- Bootstrap block **386.816** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (28/May/19)
- Bootstrap block **386.816** for InnovaCoin Linux hot masternode.
