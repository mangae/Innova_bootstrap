# InnovaCoin
## Windows wallet - bootstrap (03/Jun/19)
- Bootstrap block **390.347** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (03/Jun/19)
- Bootstrap block **390.347** for InnovaCoin Linux hot masternode.
