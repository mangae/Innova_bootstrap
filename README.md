# InnovaCoin
## Windows wallet - bootstrap (30/Sep/19)
- Bootstrap block ***447.833*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (30/Sep/19)
- Bootstrap block ***447.833*** for InnovaCoin Linux hot masternode.
