# InnovaCoin
## Windows wallet - bootstrap (04/Jun/19)
- Bootstrap block **391.188** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (04/Jun/19)
- Bootstrap block **391.188** for InnovaCoin Linux hot masternode.
