# InnovaCoin
## Windows wallet - bootstrap (25/Jul/19)
- Bootstrap block ***416.317*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (25/Jul/19)
- Bootstrap block ***416.317*** for InnovaCoin Linux hot masternode.
