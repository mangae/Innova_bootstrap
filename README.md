# InnovaCoin
## Windows wallet - bootstrap (03/Sep/19)
- Bootstrap block ***438.618*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (03/Sep/19)
- Bootstrap block ***438.618*** for InnovaCoin Linux hot masternode.
