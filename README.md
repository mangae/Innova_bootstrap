# InnovaCoin
## Windows wallet - bootstrap (21/Sep/19)
- Bootstrap block ***444.826*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (21/Sep/19)
- Bootstrap block ***444.826*** for InnovaCoin Linux hot masternode.
