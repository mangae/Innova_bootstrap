...
## Windows wallet - bootstrap (01/Feb/20)
- Bootstrap block ***170.664*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (01/Feb/20)
- Bootstrap block ***170.664*** for InnovaCoin Linux hot masternode.
