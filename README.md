# InnovaCoin
## Windows wallet - bootstrap (17/Jul/19)
- Bootstrap block ***411.884*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (17/Jul/19)
- Bootstrap block ***411.884*** for InnovaCoin Linux hot masternode.
