# InnovaCoin
## Windows wallet - bootstrap (30/May/19)
- Bootstrap block **388.365** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (30/May/19)
- Bootstrap block **388.365** for InnovaCoin Linux hot masternode.
