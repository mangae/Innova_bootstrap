# InnovaCoin
## Windows wallet - bootstrap (22/Jun/19)
- Bootstrap block ***399.330*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (22/Jun/19)
- Bootstrap block ***399.330*** for InnovaCoin Linux hot masternode.
