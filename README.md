# InnovaCoin
## Windows wallet - bootstrap (09/Jul/19)
- Bootstrap block ***408.823*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (09/Jul/19)
- Bootstrap block ***408.823*** for InnovaCoin Linux hot masternode.
