# InnovaCoin
## Windows wallet - bootstrap (27/Oct/19)
- Bootstrap block ***457.320*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (27/Oct/19)
- Bootstrap block ***457.320*** for InnovaCoin Linux hot masternode.
