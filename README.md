# InnovaCoin
## Windows wallet - bootstrap (15/Sep/19)
- Bootstrap block ***441.757*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (15/Sep/19)
- Bootstrap block ***441.757*** for InnovaCoin Linux hot masternode.
