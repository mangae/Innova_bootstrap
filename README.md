# InnovaCoin
## Windows wallet - bootstrap (09/Jun/19)
- Bootstrap block ***393.424*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (09/Jun/19)
- Bootstrap block ***393.424*** for InnovaCoin Linux hot masternode.
