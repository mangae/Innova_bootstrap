# InnovaCoin
## Windows wallet - bootstrap (03/Aug/19)
- Bootstrap block ***421.612*** for InnovaCoin Windows wallet.
...
## Linux - Masternode bootstrap (03/Aug/19)
- Bootstrap block ***421.612*** for InnovaCoin Linux hot masternode.
